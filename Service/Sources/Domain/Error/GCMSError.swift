...
extension GCMSError: LocalizedError {
    public var errorDescription: String? {
        ...
        case .invalidToken, .clubTypeError, .notFoundUser, .notExistUser, .invalidInput, .noMebmerClub, .serverError:
            return "알 수 없는 에러가 발생했습니다. 잠시 후 다시 시도해 주세요."

        case .unauthorized:
            return "로그인 세션이 만료되었습니다. 앱을 종료하고 다시 실행 해주세요."
        ...
        case .cannotKickHeadOrNotClubHead:
            return "부장이 아니거나 자기 자신을 강퇴할 수 없습니다."
